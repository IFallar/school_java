...
//TURNS
    ...
    public static int[] playerturn(String[][] handlist) {
        ...
        try {
            while(t){
                if (handlistxpos > 25) {
                    ...
                    handlistxpos = playerchoice.nextInt();
                    t = true;
                }
                else{
                    t = false;
        ...
        boolean p = true;
        while(p){
            if (handlist[handlistypos][handlistxpos].equals("..") || handlistxpos > 26) {
    ...
    public static void main(String[] args) {
        ...
        int cpturn = 0; int r = 1; int y = 1; int x = 0;
        ...
        System.out.println("CHECK EACH HAND FOR MATCHES...");
        maingame(handlist, playerhand, pchand);

        System.out.println("\n\nHeads or Tails?");
        Scanner coin = new Scanner(System.in);
        String side = coin.nextLine();


        String[] turn = {"Heads", "Tails"};
        Collections.shuffle(Arrays.asList(turn));

        System.out.println("\nCoin Toss Result: " + turn[0] + "\n");

            if(turn[0].equals(side)){

                System.out.println("Player goes first");

                boolean l = true;
                while (totalcards > 1 && l) {
        ...
        if(playerhand == 0){
            ...
            System.out.println("⠀           ⠑⡀⠀⠀⠀                  ⠀⠀⡔⠁");            
            System.out.println("             ⠈⠢⢄⠀⠀GREAT JOB BRO  ⣀⠴⠊⠀");           
            System.out.println("⠀               ⢸⠀⠀⠀⢀⣀⣀⣀⣀⣀⡀⠤⠄⠒⠈");           
            System.out.println("                 ⠘⣀⠄⠊⠁");          
            System.out.println("");           
            System.out.println("⣿⣿⣿⣿⣿⣿⣿⣿⡿⠿⠛⠛⠛⠋⠉⠈⠉⠉⠉⠉⠛⠻⢿⣿⣿⣿⣿⣿⣿⣿");            
