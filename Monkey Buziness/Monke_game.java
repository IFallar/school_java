...
//Card Distribution
    public static String[][] distribute(String[] cards, int[][] c, int[] D){
        ...
        String pchand[] = {cards[c[0][D[1]]], cards[c[0][D[2]]], cards[c[0][D[3]]], cards[c[0][D[4]]], cards[c[0][D[5]]], cards[c[0][D[6]]], cards[c[0][D[7]]], cards[c[0][D[8]]], cards[c[0][D[9]]], cards[c[0][D[10]]], cards[c[0][D[11]]], cards[c[0][D[12]]], 
        ...
        String playerhand[] = {cards[c[2][D[0]]], cards[c[2][D[1]]], cards[c[2][D[2]]], cards[c[2][D[3]]], cards[c[2][D[4]]], cards[c[2][D[5]]], cards[c[2][D[6]]], cards[c[2][D[7]]], cards[c[2][D[8]]], cards[c[2][D[9]]], cards[c[2][D[10]]], cards[c[2][D[11]]], cards[c[2][D[12]]], 
        ...
        String hands[][] = {FirstCard, pchand, playerhand};
...
//Main Game Display
    public static void game(String[][] onhand, int playerhand, int pchand) {
        ...
        System.out.println("|  |____| |____| |____| |____| |____| |____| |____| |____| |____| |____| |____| |____| |____|" + "  |  Player Hand Count Begins at [0]");
        System.out.println("|  |‾‾‾‾| |‾‾‾‾| |‾‾‾‾| |‾‾‾‾| |‾‾‾‾| |‾‾‾‾| |‾‾‾‾| |‾‾‾‾| |‾‾‾‾| |‾‾‾‾| |‾‾‾‾| |‾‾‾‾| |‾‾‾‾|" + "  |  ----------Left to Right--------");
...
//Turns
    ...
    public static int[] playerturn() {
        ...
        int[] coordinates = {line, position, retrieval, start, max};
        return coordinates;
    ...
    public static int[] matchmaking(String[][] onhand, int[] chosen){
        ...
        while(i){    
            ...
            String s1 = onhand[chosen[2]][p];
            if(s1.startsWith(Character.toString(m))){
                System.out.println("\n                                        -Match Found-");
                System.out.println("                                        |‾‾‾‾| |‾‾‾‾|");
                System.out.println("                                        | "+ a + " | | " +  onhand[chosen[2]][p] + " |");
                System.out.println("                                        |____| |____|\n");
                cardcon[0] = 1;
                cardcon[1] = 1;
                i = false;
                onhand[chosen[0]][chosen[1]] = replacer1;
                onhand[chosen[2]][p] = replacer2;
                p = 0;
            }
            else if(p <= chosen[4]){
                p++;
    ...
    public static void main(String[] args) {
        ...
        //FirtsCard = [0] pchand = onhand[1] || playerhand =  onhand[2]
        ...
        while(totalcards > 1){
            ...
            cardcon = matchmaking(onhand, Chosen);
            playerhand = playerhand - cardcon[0];
            pchand = pchand - cardcon[1];
            totalcards = playerhand + pchand;
        }
